...
<template>
   <div id="CreatePostBox" class="w-full bg-white rounded-lg px-3 mt-4 shadow-md">
    ...
    <button class="flex items-center justify-center p-1 hover:bg-[#F2F2F2] w-full  rounded-lg mx-1 cursor-pointer">
        ...
        <div class="md:block hidden text-[#6F7275] font-bold truncate">Live video</div>
    </button>
    <button class="flex items-center justify-center p-1 hover:bg-[#F2F2F2] w-full  rounded-lg mx-1 cursor-pointer">
        <Image :size="35" fillColor="#43BE62"/>
        <div class="md:block hidden text-[#6F7275] font-bold truncate">Imagem/vídeo</div>
    </button>
    <button class="flex items-center justify-center p-1 hover:bg-[#F2F2F2] w-full rounded-lg  mx-1 cursor-pointer">
        <EmoticonOutline :size="35" fillColor="#F8B927"/>
        <div class="md:block hidden text-[#6F7275] font-bold truncate">Sentimento</div>
    </button>
</div>
   </div>
</template>
